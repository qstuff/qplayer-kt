...
class SlidingTabStrip @JvmOverloads internal constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private val mBottomLinePaint: Paint
    ...
    init {
        ...
        mDefaultBottomBorderColor = DEFAULT_BOTTOM_BORDER_COLOR_ALPHA
    ...
    companion object {
        ...
        private const val DEFAULT_BOTTOM_BORDER_COLOR_ALPHA = -0x1
        private const val SELECTED_INDICATOR_THICKNESS_DIPS = 4
        private const val DEFAULT_SELECTED_INDICATOR_COLOR = -0x1000000

        private const val DEFAULT_DIVIDER_THICKNESS_DIPS = 4
